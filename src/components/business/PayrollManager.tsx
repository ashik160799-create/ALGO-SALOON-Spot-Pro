    ...
    <div className="min-h-full pb-24 bg-[#0A0A0F] text-white">
      ...
      <div className="sticky top-0 z-30 bg-[#0A0A0F]/95 backdrop-blur-md px-4 py-3 border-b border-white/5 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[10px] text-gold-400">Monthly Compensation Ledger ({currency.code})</p>
          </div>
        </div>
      ...
      <div className="px-4 pt-4 space-y-4">
        ...
        <div className="grid grid-cols-3 gap-2">
          <div className="glass-card p-3 rounded-2xl border border-gold-400/30 text-center">
            <span className="text-[9px] text-gray-400 uppercase tracking-wider block">Total Payroll</span>
            <p className="text-sm font-black text-gold-400 font-heading mt-0.5">
              {formatPrice(totalPayout)}
            </p>
          </div>

          <div className="glass-card p-3 rounded-2xl border border-white/10 text-center">
            <span className="text-[9px] text-gray-400 uppercase tracking-wider block">Commissions</span>
          ...
          <div className="glass-card p-3 rounded-2xl border border-white/10 text-center">
            <span className="text-[9px] text-gray-400 uppercase tracking-wider block">Total Services</span>
              ...
              <div
                ...
                className={`p-4 rounded-2xl border transition-all space-y-3 ${
                  isPaid
                    ...
                    : 'bg-gradient-to-br from-[#282110] to-[#151522] border-gold-400/40 shadow-sm'
                }`}
              >
                <div className="flex items-center justify-between pb-2 border-b border-white/10 text-xs">
                  ...
                  <span className={`text-[10px] font-bold px-2 py-0.5 rounded-full ${
                    isPaid ? 'bg-emerald-500/20 text-emerald-300' : 'bg-amber-400/20 text-amber-300'
                  }`}>
                    {record.status}
                  </span>
                </div>
                ...
                <div className="grid grid-cols-3 gap-2 text-[11px]">
                  <div className="bg-[#12121A] p-2 rounded-xl border border-white/5">
                  ...
                  <div className="bg-[#12121A] p-2 rounded-xl border border-white/5">
                    ...
                    <span className="font-bold text-gold-400 font-heading">{formatPrice(record.netPayout)}</span>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between text-xs pt-1">
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className="px-2.5 py-1 rounded-lg bg-[#181824] hover:bg-gold-400/10 text-gray-300 hover:text-gold-300 text-[11px] font-semibold border border-white/10"
                    >
                      Payslip
                    </button>
                    ...
                    {!isPaid && (
                      <button
                        ...
                        className="gold-gradient-btn px-3 py-1 rounded-lg text-xs font-bold shadow-sm"
                      >
                        Disburse Pay
                      </button>
                    )}
